    ...
    return (
        <>
            ...
            <div className="paymentFields">
                <div className="blur-background" style={{ backgroundImage: theme.palette.blurColor.primary }}></div>
                <Toolbar>
                    {/* EmployeeID */}
                                ...
                                >
                                    {employeeList.map(([id, name]) => (
                                        <MenuItem key={id} value={`${id}-${name}`} >
                                            <Checkbox checked={personName.includes(`${id}-${name}`)} sx={{
                                                '&.MuiCheckbox-root': {
                                                    color: theme.palette.text.primary, // Change color when unchecked
                                                },
                                            }} />
